...
Contact: team@filecoindaily.online or @filecoindaily on Filecoin Slack
...
- Clients are required to apply for DataCap using the following GitHub repo [LINK](https://github.com/filecoindaily/filplus-onboard/issues/new/choose) which contains questions related to the client role, data preparation, financing, dataset details, and storage provider distribution plan
